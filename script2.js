...
function ranking() {
  ...
  Trail = Math.floor(Math.random() * productRanking.length);
  document.getElementById('item1').innerHTML = productRanking[Trail].itemRanking.name;
  productRanking.splice(Trail,1);
Trail = Math.floor(Math.random() * productRanking.length);
  document.getElementById('item2').innerHTML = productRanking[Trail].itemRanking.name;
productRanking.splice(Trail,1);
Trail = Math.floor(Math.random() * productRanking.length);
document.getElementById('item3').innerHTML = productRanking[Trail].itemRanking.name;
productRanking.splice(Trail,1);
Trail = Math.floor(Math.random() * productRanking.length);
document.getElementById('item4').innerHTML = productRanking[Trail].itemRanking.name;
productRanking.splice(Trail,1);
Trail = Math.floor(Math.random() * productRanking.length);
document.getElementById('item5').innerHTML = productRanking[Trail].itemRanking.name;
productRanking.splice(Trail,1);
Trail = Math.floor(Math.random() * productRanking.length);
document.getElementById('item6').innerHTML = productRanking[Trail].itemRanking.name;
productRanking.splice(Trail,1);
Trail = Math.floor(Math.random() * productRanking.length);
document.getElementById('item7').innerHTML = productRanking[Trail].itemRanking.name;
productRanking.splice(Trail,1);
Trail = Math.floor(Math.random() * productRanking.length);
document.getElementById('item8').innerHTML = productRanking[Trail].itemRanking.name;
productRanking.splice(Trail,1);
Trail = Math.floor(Math.random() * productRanking.length);
document.getElementById('item9').innerHTML = productRanking[Trail].itemRanking.name;
productRanking.splice(Trail,1);
